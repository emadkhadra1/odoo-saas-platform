...
class Entrepreneurs(models.Model):
    ...
    sub_item_id = fields.Many2one(related="indexation_id.sub_item_id", string="البند الفرعي", required=False )
    ...
    sub_business_statement_id = fields.Many2one(related="indexation_id.sub_business_statement_id",  string="البند الفرعي الثاني", required=False)
