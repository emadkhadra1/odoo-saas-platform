...
class ProgressOwnerLines(models.Model):
    ...
    main_item_id = fields.Many2one("b2b.main.items", string="Main Item", required=True, readonly=False)
    sub_item_id = fields.Many2one("b2b.sub.items", string="Sub Item", required=True, readonly=False)
    ...
    sub_business_statement_id = fields.Many2one("b2b.sub.business.items", string="Second Sub Item", required=False, readonly=False, store=True)
