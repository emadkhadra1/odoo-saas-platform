...
class BoqSubBusinessStatement(models.Model):
    ...
    sub_item_id = fields.Many2one("b2b.sub.items", string="Sub Item", store=True)
    main_item_id = fields.Many2one(related="sub_item_id.main_item_id", string="Main Item", readonly=True, store=True)
