...
class construction_tool(models.Model):
    _name = 'construction.tool'
    _rec_name = 'name'
    _description = 'construction_tool'
    ...
    def create_account_move(self):
        ...
        move_vals = {
            ...
            'state': 'draft',
            'ref': 'Order tools for %s' % self.project_id.name,
...
class construction_tool_line(models.Model):
    _name = 'construction.tool.line'
    ...
    def onchange_tool_id(self):

        if self.tool_id:
            self.name = self.tool_id.name
            self.unit_cost = self.tool_id.unit_cost
