    ...
    def _run_activity_reminder(self):
        ...
        for company in company_ids:
            if company.sh_display_activity_reminder:
                alarm_ids = self.env['sh.activity.alarm'].sudo().search([('company_id','=',company.id)])
                if alarm_ids:
                                                ...
                                                for user_id in user_ids:
                                                    ...
                                                    if notification_user_id:
                                                        notifications.append([
                                                            ...
                                                            {'type': 'simple_notification', 'title': _('Activity Reminder '+'('+str(activity.activity_type_id.name)+')'), 'message':  message, 'sticky': True, 'warning': False}  # sorted to make deterministic for tests
                                                        ])
