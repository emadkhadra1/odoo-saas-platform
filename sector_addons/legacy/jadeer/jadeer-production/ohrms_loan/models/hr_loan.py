...
class HrLoan(models.Model):
    ...
    #     if not result.get('original_loan_id'):
    ...
    #     else:
    #         original_loan = result.get('original_loan_id')
    #         original_loan_obj = self.browse(original_loan)
    #         result['employee_id'] = original_loan_obj.employee_id.id
    #     return result
