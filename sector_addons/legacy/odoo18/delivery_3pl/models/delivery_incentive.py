...
class DeliveryValidityCriteria(models.Model):
    ...
    min_daily_peak_hours = fields.Float(string='Min Daily Peak Hours (ساعات الذروة)', digits=(5, 2), default=0.0,
                                         help='Minimum peak hours required per valid day (e.g. HungerStation HP: 4 hours). Set 0 to disable.')
