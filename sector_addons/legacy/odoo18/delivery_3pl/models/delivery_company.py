...
class DeliveryCompany(models.Model):
    ...
    operations_manager_id = fields.Many2one('res.users', string='Operations Manager (مدير العمليات)',
                                             tracking=True,
                                             help='مدير العمليات المسؤول عن هذه الشركة. لن يرى إلا البيانات الخاصة بالشركات المعيّن عليها.')
