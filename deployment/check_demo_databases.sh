...
print_db_row "real-estate" "tenant_template_realestate" "real_estate" "-"
print_db_row "real-estate" "demo_realestate" "real_estate" "${PUBLIC_BASE_URL}/web/login?db=demo_realestate"
print_db_row "hr" "tenant_template_saudi_hr" "hr_custody" "-"
print_db_row "hr" "demo_hr" "hr_custody" "${PUBLIC_BASE_URL}/web/login?db=demo_hr"
